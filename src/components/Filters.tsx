...
const FilterPanel: React.FC<FilterPanelProps> = ({ 
  fetchArticlesAction, articles, 
  loading,selectedDate, setSelectedDate,selectedCategory, 
  setSelectedCategory,selectedSource, setSelectedSource ,search, 
  setSearch,handleResetFilters}) => {
  ...
  useEffect(() => {
    const filters = { keyword: selectedCategory?selectedCategory:null, source: selectedSource?selectedSource:null}; // Replace "technology" with the desired keyword.
  ...
  return (
    <Paper sx={{ padding:'15px'}}>
      ...
      <Box  sx={{display:'flex', flexDirection:'row', gap:'10px', alignItems:'center'}}>
       <Button sx={{width:'100%'}} variant='contained' onClick={handleResetFilters}>Reset Filter</Button>
      </Box>
      </Grid2>
      </Grid2>
    </Paper>
